---
layout:       post
title:        Dynamically adjust threadpool configuration
category:     tech
...
<p><img src="/img/posts/tech/dynamically-adjust-threadpool-configuration-arch-design.png" alt="arch design" width="850"></p>

## 监控报警

发布测试环境后, 监控效果图如下, 当然你可以根据自己的实际情况去设置合理的报警阈值

<p><img src="/img/posts/tech/threadpool-monitor.png" alt="arch design" width="850"></p>
